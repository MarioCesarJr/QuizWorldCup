...
public class TelaOpcao extends JFrame {
	...
	public TelaOpcao() {
		...
		rdbtnFcil.setToolTipText("Sua pontuação multiplicará o tempo por 5");
		...
		rdbtnMedio.setToolTipText("Sua pontuação multiplicará o tempo por 7");
		...
		rdbtnDifcil.setToolTipText("Sua pontuação multiplicará o tempo por 9");
		...
		JButton btnVoltar = new JButton("Confirmar nível");
		btnVoltar.setBackground(SystemColor.menu);
		btnVoltar.setFont(new Font("Tahoma", Font.BOLD, 15));
		btnVoltar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent a) {
				// jogo é uma instancia da Classe Quiz do pacote controller.
